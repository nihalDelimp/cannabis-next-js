  ...
  return (
    <Html lang="en">
      ...
      <Head>
        ...
        <meta property="og:type" content="What is canabis capitol?" />
        <meta property="og:site_name" content="What is Web3?" />
        <meta property="og:description" content="canabis  capitol is the next step in the evolution of the internet and, possibly, the organization of society. According to legend, Web 1.0 was the era of decentralized, open protocols, when the majority of internet activity consisted of visiting individual static webpages." />
        <meta property="og:title" content="What is canabis capitol" />
        <meta property="og:image" content=      "https://images.unsplash.com/photo-1685052391251-e09402a6b8e8?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=715&q=80" />
